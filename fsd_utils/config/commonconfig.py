...
class CommonConfig:
    ...
    MOCK_FUND_ID = "af265ca8-857f-4333-b86f-436fed838773"
    MOCK_ROUND_1_ID = "94f8cb8b-057d-4f4a-b4a8-7274f695cd6f"
    ...
    f"{MOCK_FUND_ID}:{MOCK_ROUND_1_ID}": TEST_ORDERED_FORMS_CONFIG
    }
